...
def streamlit_init(stimulus_df, membrane_potential_df, n_df, m_df, h_df, v_df_1, v_df_2, v_df_3):
    ...
    voltage_propogation_df = pd.DataFrame({"Voltage after 1mm": v_df_1, 'Voltage after 5mm': v_df_2, 'Voltage after 10mm': v_df_3})
