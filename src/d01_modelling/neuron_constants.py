neuron_const = {
    ...
    "g_na_max": 120,  # sodium max conductance with units mS/cm^2
    "g_k_max": 36,  # potassium max conductance with units mS/cm^2
    "g_l_max": 0.3,  # leak max conductance with units mS/cm^2
    "E_na": 55,  # sodium nernst potential with units mV
    "E_k": -75,  # potassium nernst potential with units mV
    "E_l": -50,  # leak nernst potential with units mV
}
